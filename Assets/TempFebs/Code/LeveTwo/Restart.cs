...
public class Restart : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Level one score: " + levelOneScore.ToString());
        if (levelOneScore < 10)
        {
        ...
        if(levelOneScore >= 10 &&  levelOtwoScore >= 10){
            txtcongrats.text = "Congartilations mission is complete!";
        }
        else
        {
            txtcongrats.text = "Soryy mission is not complete retry";
        }
    }
